			...
			<ul className='flex gap-4 p-4'>
				<li>
					<Link href="/" className='block' onClick={() => { cleanQuestions(); cleanWildCards() }}>
						<BiArrowBack color='#0f172a' className='text-4xl hover:scale-105 transition-all  p-1 bg-white rounded' title='Буцах' />
					</Link>
				</li>
				<li>
					<button className='hover:scale-105 transition-all p-1 bg-white rounded' onClick={() => document.getElementById('newGameDialog').showModal()}>
						<BsArrowRepeat className='text-[28px]' color='#0f172a' title='Дахин эхлэх' />
					</button>
				</li>
			</ul>
		</nav>

...
export default function NewGameForm () {
	...
	return (
		<dialog ref={dialog} onClick={(e) => clickOutsideDialog(e)} id="newGameDialog" 
			...
			<form onSubmit={(e) => e.preventDefault()} >
				...
				<button type='submit' className='btn-primary uppercase py-3 px-6 w-full tracking-widest' onClick={(e) => handleSubmit(e)}>Эхлэх</button>
			</form>
		</dialog >
	)
}
